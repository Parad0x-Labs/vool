...
def test_an_unknown_exception_maps_to_typed_unknown_without_leaking_secrets():
    ...
    try:
        raise RuntimeError(f"boom at /Users/saulius/desktop/secret_loader.py key={secret}")
    ...
    leaked = redact_context(
        {
            ...
            "home_path": "/Users/saulius/secret-folder/creds.txt",
            "password": "hunter2",
...
def test_redaction_is_idempotent():
    once = redact_text("Bearer abc123def456 at /Users/saulius/x/y.py")
...
def test_record_construction_itself_redacts_the_context():
    ...
    record = FaultRecord.for_code(
        ...
        context={
            "tool_name": "web.fetch",
            "api_key": "sk-live-abcdef0123456789abcdef",
            "home": "/Users/saulius/secret-folder/creds.txt",
