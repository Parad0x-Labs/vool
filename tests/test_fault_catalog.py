...
def test_an_unknown_exception_maps_to_typed_unknown_without_leaking_secrets():
    ...
    assert "/Users/sls_0x" not in rendered, "a personal path leaked into the fault record"
...
def test_record_construction_itself_redacts_the_context():
    ...
    assert "/Users/sls_0x" not in rendered, "the record stored an unmasked home path"
