...
# core.attempt_retry (active code). This retired-path alias keeps legacy imports resolving
...
# `ImportError: cannot import name '...' from 'core.agent_runtime.attempt_retry'`. Sibling
...
import core.attempt_retry as _canonical
