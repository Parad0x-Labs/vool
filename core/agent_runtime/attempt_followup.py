...
# core.attempt_followup (active code). This retired-path alias keeps legacy imports resolving
...
# `ImportError: cannot import name '...' from 'core.agent_runtime.attempt_followup'`. Sibling
...
import core.attempt_followup as _canonical
